...
class Project {
  ...
  Project({this.id, this.projectName, this.projectColor, this.projectClient});

  Project.fromJson(Map<String, Object?> data, DocumentSnapshot snapshot)
    : this(
        id: snapshot.id,
        projectName: data['projectName'] as String?,
        projectClient: data['projectClient'] as String?,
        projectColor: data['projectColor'] as int?,
    );
