...
class DateAndTimePickers {
  ...
  Future selectDate({BuildContext context, DateTime initialDate, Function(DateTime) saveDate}) async {
  ...
  Future selectTime({BuildContext context, TimeOfDay initialTime, Function(TimeOfDay) saveTime}) async {
  ...
  TimeRangePicker buildTimeRangePicker({BuildContext context, Function(TimeRangeValue) saveTimeRange}) {
